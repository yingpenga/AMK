...
class Generator:
    ...
    def generate(self, prompt, image):
        ...
        inputs_test = input_ids.clone().detach()
        inputs_test[inputs_test < 0] = 0
        inputs_test = self.tokenizer.batch_decode(inputs_test,skip_special_tokens=True)[0]
        print(">>>test prompt: ", inputs_test)
